...
void main() {
    ...
    vertexNormal = triangleBaricentricCoords.x * vertexNormalIn[0] + triangleBaricentricCoords.y * vertexNormalIn[1] + triangleBaricentricCoords.z * vertexNormalIn[2];//(vertexNormalIn[0] + vertexNormalIn[1] + vertexNormalIn[2]) / 3.0f;
