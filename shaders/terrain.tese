...
float noiseHeight(vec3 pos){
    return openSimplex2_Conventional(pos * 0.002f).w * 2.5f + openSimplex2_Conventional(pos * 0.08f).w - openSimplex2_Conventional(pos * 0.8f).w * 0.3f;
}

vec3 noiseNormal(vec3 pos){
    return (openSimplex2_Conventional(pos * 0.002f).xyz +
        openSimplex2_Conventional(pos * 0.08f).xyz -
        openSimplex2_Conventional(pos * 0.8f).xyz) / 3.0f;
}
